package com.xyz.tiger.dao.base;
...
public interface IBaseDao<T extends Serializable, PK extends Serializable> {
	 ...
	 * @return 全部记录实体对象的List
	 */
	List<T> selectPagination(Cnds cnds, int offset, int rows);
	 ...
	 * @return 全部记录List<Map<String, Object>>
	 */
	List<Map<String, Object>> selectPaginationM(Cnds cnds, int offset, int rows);
